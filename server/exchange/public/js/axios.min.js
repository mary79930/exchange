/* axios v1.2.1 | by https://unpkg.com/axios@1.2.1/dist/axios.min.js */
!(function (e, t) {
        ...
        if (U.isFormData(e) && U.isFunction(e.entries)) {
            ...
            return (
                U.forEachEntry(e, function (e, r) {
                    t(
                        (function (e) {
                            return U.matchAll(/\w+|\[(\w*)]/g, e).map(function (
                                e
                            ) {
                                return "[]" === e[0] ? "" : e[1] || e[0];
                            });
        ...
        transformRequest: [
            function (e, t) {
                var n,
                    ...
                    i = U.isObject(e);
                if (
                    (i && U.isHTMLForm(e) && (e = new FormData(e)),
                    U.isFormData(e))
                )
            ...
            r(
                        ...
                        value: function (e) {
                            ...
                            return (
                                U.forEach(this, function (r, o) {
                                    var i = U.findKey(n, o);
                                    if (i)
                                        return (t[i] = de(r)), void delete t[o];
                                    var a = e
                                        ? (function (e) {
                                              return e
                                                  .trim()
                ...
                [
                    ...
                    },
                    {
                        key: "accessor",
                        value: function (e) {
                            var t = (this[fe] = this[fe] = { accessors: {} })
                                    .accessors,
                                n = this.prototype;
                            function r(e) {
                                var r = le(e);
            ...
            function (e) {
                return new Promise(function (t, n) {
                    ...
                    if (
                        ...
                        (u.onerror = function () {
                            n(new F("Network Error", F.ERR_NETWORK, e, u)),
                                (u = null);
                        }),
    ...
    var Re = function (e) {
        for (
            ...
            o < r &&
            ((t = e[o]), !(n = U.isString(t) ? Se[t.toLowerCase()] : t));
            o++
        );
        if (!n) {
            if (!1 === n)
                        ...
                        value: function (e, t) {
                            ...
                            void 0 !== o &&
                                Pe.assertOptions(
                                    o,
                                    {
                                        silentJSONParsing: _e.transitional(
                                            _e.boolean
                                        ),
                                        forcedJSONParsing: _e.transitional(
                                            _e.boolean
                                        ),
                                        clarifyTimeoutError: _e.transitional(
                                            _e.boolean
                                        ),
                                    },
                                    !1
